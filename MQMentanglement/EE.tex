...
\end{aligned}
\end{equation}
where $c$ is a non universal contribution and $g$ is the boundary entropy term found by Aﬄeck and Ludwig~\cite{Affleck:1991tk}. These formula are actually very efficient when one wants to extract the central charge of a critical system in 1+1 dimension.
