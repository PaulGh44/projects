...
\end{aligned}
\end{equation}
In absence of boundaries, the boundary term vanishes. This term is acutally relevant when discussing about the numerical computation  for the discretized as it induces important side effects. If we impose Neumann boundary condition at the endpoints, this trivially vanishes. It also vanishes providing we impose periodic boundary conditions.
