...
\paragraph{Numerical implementation/First order autonomous equations}
...
\begin{equation}
  (d-1)(d-2)\Omega_k - \frac{(d-2)}{d}-\frac{2}{d}\frac{a''}{a}\frac{1}{H^2}+x^2-y^2=0\,.
\end{equation}
...
\begin{equation}
  (d-1)(d-2)\Omega_k - \frac{(d-2)}{d}-\frac{2}{d}-\frac{2}{d}\frac{H'}{H^2}+x^2-y^2=0\,.
\end{equation}
Hence,
\begin{equation}
  \frac{H'}{H^2} = \frac{d}{2}\left(x^2-y^2-1+(d-1)(d-2)\Omega_k(x,y)\right)\,.
\end{equation}
From the eom of the axion, we obtain
\begin{equation}
  \frac{\chi''}{H^2} + \frac{d\chi'}{H}+\frac{\partial_\chi V_{\rm eff}}{H^2}=0\,.
\end{equation} 
Now we will express the equations of $x$ and $y$ in terms of the conformal time $d\eta = H d\tau = d(\log a)$. It suffices to take derivatives wrt the conformal time of the first order variables $x,y$.
\begin{equation}
  \begin{aligned}
    \frac{dx}{d\eta}&=\frac{1}{H}\frac{dx}{d\tau} = -\frac{H'}{H^2}x+\frac{\chi''}{H^2}\sqrt{\frac{\kappa}{d(d-1)}}\\
    &=x \frac{d}{2}\left(y^2+1-x^2-(d-1)(d-2)\Omega_k(x,y)\right)-\sqrt{\frac{\kappa}{d(d-1)}}\frac{d\chi'}{H}-\frac{\partial_\chi V_{\rm eff}}{H^2}\sqrt{\frac{\kappa}{d(d-1)}}\,.
  \end{aligned}
\end{equation}
...
\begin{equation}
  \frac{dx}{d\eta}=x \frac{d}{2}\left(y^2+1-x^2-(d-1)(d-2)\Omega_k(x,y)\right)-dx-\frac{\sqrt{d(d-1)}}{2}\lambda y^2\,.
\end{equation}
...
\begin{equation}
  \begin{aligned}
    ...
    &=y\frac{d}{2}\left(y^2+1-x^2-(d-1)(d-2)\Omega_k(x,y)\right)+\frac{\sqrt{d(d-1)}}{2} x y \lambda\,.
  \end{aligned}
\end{equation}
...
\begin{equation}\label{eq:thirdorderautonomousystem}
  \begin{aligned}
    \frac{dx}{d\eta}&=x \frac{d}{2}\left(y^2+1-x^2-(d-1)(d-2)\Omega_k(x,y)\right)-dx-\frac{\sqrt{d(d-1)}}{2}\lambda y^2\,,\\
    \frac{dy}{d\eta} &=y\frac{d}{2}\left(y^2+1-x^2-(d-1)(d-2)\Omega_k(x,y)\right)+\frac{\sqrt{d(d-1)}}{2} x y \lambda\,\\
...
\begin{equation}
  \begin{aligned}
    ...
    \Gamma(\lambda) = 1-\frac{2f_\chi^2}{\kappa}\frac{1}{\lambda^2}\,.
  \end{aligned}
\end{equation}
...
\begin{equation}\label{eq:thirdorderautonomousystem}
  \begin{aligned}
    \frac{dx}{d\eta}&=x \frac{d}{2}\left(y^2+1-x^2-(d-1)(d-2)\Omega_k(x,y)\right)-dx-\frac{\sqrt{d(d-1)}}{2}\lambda y^2\,,\\
    \frac{dy}{d\eta} &=y\frac{d}{2}\left(y^2+1-x^2-(d-1)(d-2)\Omega_k(x,y)\right)+\frac{\sqrt{d(d-1)}}{2} x y \lambda\,\\
    \frac{d\lambda}{d\eta}  &= \frac{\sqrt{d(d-1)}f_\chi^2}{\kappa}\,x\,.
  \end{aligned}
\end{equation}
In particular, critical points have to satisfy $x_\star=0$ from the third equation. From the second equation, we have two possibilities. Either, $y_\star =0$ or $y^2+1-(d-1)(d-2)\Omega_k(x,y)=0\Rightarrow y^2=-1$. So the only possibility is $y_\star=0$ and this is compatible with the first equation. What about $\lambda_\star$ ?
\end{document}
