...
\begin{equation}
  \begin{aligned}
    \mathcal{S}_{GHY} = -\frac{dV_{d}a'a^{d-1}}{\kappa N}\Bigg|_{\partial M}\sp \mathcal{S}_{\partial M} = -\frac{V_d}{N}\,a^d \chi \partial_\tau \chi \Bigg|_{\partial M}+\mathcal{S}_{GHY}+\,.
  \end{aligned}
\end{equation}
...
\begin{equation}
  \begin{aligned}
    ...
    \frac{(d-1)(d-2)}{a^2}\left(k+\frac{a'^2}{N^2}\right)-\frac{2d(d-1)}{Na^{d-1}}\frac{d}{d\tau}\left(\frac{a' a^{d-2}}{N}\right)+2\kappa \left(\frac{(\partial_\tau \chi)^2}{2N^2}-V_{\rm np}(\chi)-\frac{\Lambda}{\kappa}\right)&=0\,.
  \end{aligned}
\end{equation}
\paragraph{Non-running solutions}
A trivial set of solutions can be obtained by setting $\chi$ to a extremum of the potential. These solutions will define the vacuum (background) of the more general solutions. Let $V_{\rm np}^{\rm ext}$ an extremum of the non-perturbative potential. The geometry of the solution depends crucially on the sign of $\Lambda_{\rm eff}=\kappa V_{\rm np}^{\rm ext}+\Lambda$. 
